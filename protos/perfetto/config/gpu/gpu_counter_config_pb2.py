...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'protos.perfetto.config.gpu.gpu_counter_config_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:

  DESCRIPTOR._options = None
  _GPUCOUNTERCONFIG._serialized_start=72
  _GPUCOUNTERCONFIG._serialized_end=192
