...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'protos.perfetto.config.gpu.vulkan_memory_config_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:

  DESCRIPTOR._options = None
  _VULKANMEMORYCONFIG._serialized_start=74
  _VULKANMEMORYCONFIG._serialized_end=164
