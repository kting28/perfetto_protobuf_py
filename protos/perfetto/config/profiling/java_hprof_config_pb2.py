...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'protos.perfetto.config.profiling.java_hprof_config_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:

  DESCRIPTOR._options = None
  _JAVAHPROFCONFIG._serialized_start=78
  _JAVAHPROFCONFIG._serialized_end=431
  _JAVAHPROFCONFIG_CONTINUOUSDUMPCONFIG._serialized_start=327
  _JAVAHPROFCONFIG_CONTINUOUSDUMPCONFIG._serialized_end=431
