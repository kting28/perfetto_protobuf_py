...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'protos.perfetto.config.track_event.track_event_config_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:

  DESCRIPTOR._options = None
  _TRACKEVENTCONFIG._serialized_start=81
  _TRACKEVENTCONFIG._serialized_end=383
