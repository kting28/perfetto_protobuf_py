...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'protos.perfetto.config.android.network_trace_config_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:

  DESCRIPTOR._options = None
  _NETWORKPACKETTRACECONFIG._serialized_start=79
  _NETWORKPACKETTRACECONFIG._serialized_end=250
