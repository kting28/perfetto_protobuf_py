...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'protos.perfetto.trace.gpu.gpu_render_stage_event_pb2', globals())
if _descriptor._USE_C_DESCRIPTORS == False:

  DESCRIPTOR._options = None
  _GPURENDERSTAGEEVENT.fields_by_name['specifications']._options = None
  _GPURENDERSTAGEEVENT.fields_by_name['specifications']._serialized_options = b'\030\001'
  _GPURENDERSTAGEEVENT.fields_by_name['hw_queue_id']._options = None
  _GPURENDERSTAGEEVENT.fields_by_name['hw_queue_id']._serialized_options = b'\030\001'
  _GPURENDERSTAGEEVENT.fields_by_name['stage_id']._options = None
  _GPURENDERSTAGEEVENT.fields_by_name['stage_id']._serialized_options = b'\030\001'
  _GPURENDERSTAGEEVENT._serialized_start=76
  _GPURENDERSTAGEEVENT._serialized_end=962
  _GPURENDERSTAGEEVENT_EXTRADATA._serialized_start=552
  _GPURENDERSTAGEEVENT_EXTRADATA._serialized_end=592
  _GPURENDERSTAGEEVENT_SPECIFICATIONS._serialized_start=595
  _GPURENDERSTAGEEVENT_SPECIFICATIONS._serialized_end=956
  _GPURENDERSTAGEEVENT_SPECIFICATIONS_CONTEXTSPEC._serialized_start=863
  _GPURENDERSTAGEEVENT_SPECIFICATIONS_CONTEXTSPEC._serialized_end=906
  _GPURENDERSTAGEEVENT_SPECIFICATIONS_DESCRIPTION._serialized_start=908
  _GPURENDERSTAGEEVENT_SPECIFICATIONS_DESCRIPTION._serialized_end=956
  _INTERNEDGRAPHICSCONTEXT._serialized_start=965
  _INTERNEDGRAPHICSCONTEXT._serialized_end=1135
  _INTERNEDGRAPHICSCONTEXT_API._serialized_start=1077
  _INTERNEDGRAPHICSCONTEXT_API._serialized_end=1135
  _INTERNEDGPURENDERSTAGESPECIFICATION._serialized_start=1138
  _INTERNEDGPURENDERSTAGESPECIFICATION._serialized_end=1376
  _INTERNEDGPURENDERSTAGESPECIFICATION_RENDERSTAGECATEGORY._serialized_start=1317
  _INTERNEDGPURENDERSTAGESPECIFICATION_RENDERSTAGECATEGORY._serialized_end=1376
